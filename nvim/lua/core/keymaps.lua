...
vim.keymap.set("n", "<leader>x", ":Bdelete!<CR>", descopt("Delete Buffer")) -- close buffer
...
vim.keymap.set("n", "<leader>tlw", "<cmd>set wrap!<CR>", opts)
